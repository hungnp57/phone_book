...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('/plugins/font-awesome-4.5.0/css/font-awesome.min.css') }}" type="text/css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('/plugins/ionicons-2.0.1/css/ionicons.min.css') }} type="text/css"">
    <!-- Theme style -->
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('/plugins/iCheck/flat/blue.css') }}" type="text/css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ asset('/plugins/morris/morris.css') }}" type="text/css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ asset('/plugins/jvectormap/jquery-jvectormap-1.2.2.css') }}" type="text/css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ asset('/plugins/datepicker/datepicker3.css') }}" type="text/css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ asset('/plugins/daterangepicker/daterangepicker-bs3.css') }}" type="text/css">
    ...
    <style type="text/css">
      .timeline-item:hover{
        ...
        box-shadow: 0 8px 8px rgba(1,67,163,.24),0 0 8px rgba(1,67,163,.12),0 6px 18px rgba(43,133,231,.12)!important;
        border-color: #2B85E7!important;
...
function spawnNotification(theBody,theIcon,theTitle) {
  ...
  var n = new Notification(theTitle,options);
      ...
      var contentMessages = ['Support Team send you a message','Nguyễn Phi Hùng cập nhật thông tin cá nhân','Phòng 301có thêm nhân viên mới','Thay đổi chức vụ trưởng phòng 301','CREA đã cập nhật lịch làm việc'];
      var s1 =  '<li class="all-item">'          
              +'<i class="fa fa-envelope bg-blue"></i>'
              +'<div class="timeline-item">'
              +'<span class="time"><i class="fa fa-clock-o"></i> 12:05</span>'
              +'<h3 class="timeline-header">'+contentMessages[0]+'</h3>'
              ...
              +'</div>'
              +'</li>';
              var s2 =  '<li class="all-item">'          
              +'<i class="fa fa-envelope bg-blue"></i>'
              +'<div class="timeline-item">'
              +'<span class="time"><i class="fa fa-clock-o"></i> 12:05</span>'
              +'<h3 class="timeline-header">'+contentMessages[1]+'</h3>'
              +'<div class="timeline-body">'
              +'Nơi ở: ' +'Hải Dương'
              +'</div>'
              +'<div class="timeline-footer">'
              ...
              +'</div>'
              +'</li>';
              var s3 =  '<li class="all-item">'          
              +'<i class="fa fa-envelope bg-blue"></i>'
              +'<div class="timeline-item">'
              +'<span class="time"><i class="fa fa-clock-o"></i> 12:05</span>'
              +'<h3 class="timeline-header">'+contentMessages[2]+'</h3>'
              +'<div class="timeline-body">'
              +'Nhân viên YukiUsagi' +' Mã nhân viên 12020183'
              +'</div>'
              +'<div class="timeline-footer">'
              +'<a class="btn btn-primary btn-xs">...</a>'
              +'</div>'
              +'</div>'
              +'</li>';
              var s4 =  '<li class="all-item">'          
              +'<i class="fa fa-envelope bg-blue"></i>'
              +'<div class="timeline-item">'
              +'<span class="time"><i class="fa fa-clock-o"></i> 12:05</span>'
              +'<h3 class="timeline-header">'+contentMessages[3]+'</h3>'
              +'<div class="timeline-body">'
              +'Trưởng phòng mới: CREA'
              +'</div>'
              +'<div class="timeline-footer">'
              +'<a class="btn btn-primary btn-xs">...</a>'
              +'</div>'
              +'</div>'
              +'</li>';
              var s5 =  '<li class="all-item">'          
              +'<i class="fa fa-envelope bg-blue"></i>'
              +'<div class="timeline-item">'
              +'<span class="time"><i class="fa fa-clock-o"></i> 12:05</span>'
              +'<h3 class="timeline-header">'+contentMessages[4]+'</h3>'
              +'<div class="timeline-body">'
              +'Cập nhật lịch làm việc. Xem chi tiết'
              +'</div>'
              +'<div class="timeline-footer">'
              +'<a class="btn btn-primary btn-xs">...</a>'
              +'</div>'
              +'</div>'
              +'</li>';
      var messages = [s1,s2,s3,s4,s5];
      function myTimer() {
          // $("#all .timeline").prepend(messages[Math.floor(Math.random() * 5)] );
          var rand= Math.floor(Math.random() * 5);
          var s=messages[rand];
          $(s).hide().prependTo("#all .timeline").fadeIn(1000);
          //notifyMe(contentMessages[rand]);

          if($("#all .timeline li").length>=10){


          $("#all .timeline li:last").remove();
        }
      }
      function stop(){
        clearInterval(myVar);
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <header class="main-header">
        ...
        <a href="{{URL::to('/home') }}" class="logo">
          ...
          <span class="logo-mini"><b>Q</b>LB</span>
            ...
            <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      {{ Auth::user()->name }} - Lập trình viên
                      <small>Nhân viên từ Nov. 2012</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{ url('/auth/logout') }}" class="btn btn-default btn-flat">Đăng xuất</a>
                    </div>
                  </li>
                </ul>
              </li>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>Bạn là khách</p>
              <a href="#"><i class="fa fa-circle text-success"></i> Bạn chưa đăng nhập</a>
            </div>

            @else
            <div class="pull-left info">
              <p>Nguyễn Phi Hùng</p>
              <a href="#"><i class="fa fa-circle text-success"></i> Quản lý cấp cao(Super Admin)</a>
            </div>
            @endif
          </div>
          <!-- search form -->
    ...
    @yield('content')
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2016 <a href="../home">YukiUsagi@AHSforum.com</a>.</strong> Mọi quyền đều được bảo vệ.
      </footer>
